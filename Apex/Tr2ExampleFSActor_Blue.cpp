...
BLUE_DEFINE( Tr2ExampleFSActor );

const Be::ClassInfo* Tr2ExampleFSActor::ExposeToBlue()
{
    EXPOSURE_BEGIN( Tr2ExampleFSActor, "" )
        MAP_INTERFACE( Tr2ExampleFSActor )
		MAP_INTERFACE( IInitialize )

		MAP_ATTRIBUTE( "name", m_name, "", Be::READWRITE | Be::PERSIST )
		MAP_PROPERTY( "resPath", GetResPath, SetResPath, "Resource path to ExampleFS asset file" )
