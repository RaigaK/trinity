...
const Be::ClassInfo* Tr2SpotLight::ExposeToBlue()
{
	EXPOSURE_BEGIN( Tr2SpotLight, "" )
		...
		MAP_ATTRIBUTE( "length", m_lightData.length, "Light length", Be::READWRITE | Be::PERSIST )
		MAP_ATTRIBUTE( "radius", m_lightData.radius, "Outer radius of the spotlight", Be::READWRITE | Be::PERSIST )
		MAP_ATTRIBUTE( "innerRadius", m_lightData.innerRadius, "Inner radius of the spotlight", Be::READWRITE | Be::PERSIST )
		MAP_ATTRIBUTE( "angle", m_lightData.angle, "Angle of the spotlight ", Be::READ )
