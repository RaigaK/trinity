...
extern const Be::VarChooser TriZBufferType[];
...
extern const Be::VarChooser TriVertexDeclUsage[];
...
extern const Be::VarChooser TriPrimitiveType[];
extern const Be::VarChooser TriTransformBaseFlags[];
extern const Be::VarChooser TriLodBy[];
extern const Be::VarChooser TriCull[];
extern const Be::VarChooser TriShadeMode[];
extern const Be::VarChooser TriFillMode[];
extern const Be::VarChooser TriLightChooser[];
extern const Be::VarChooser TriCmpFunc[];
extern const Be::VarChooser TriBlendOp[];
extern const Be::VarChooser TriBlend[];
extern const Be::VarChooser TriTextureOp[];
extern const Be::VarChooser TriTextureTransformFlags[];
extern const Be::VarChooser TriTextureAddress[];
extern const Be::VarChooser TriTextureFilterType[];
extern const Be::VarChooser TriTextureArgFlags[];
extern const Be::VarChooser TriTexCoordIndex[];
extern const Be::VarChooser TriCubemapFaces[];
extern const Be::VarChooser TriImageFileFormat[];
extern const Be::VarChooser TriFogMode[];
extern const Be::VarChooser TriDevType[];	
extern const Be::VarChooser TriCreate[];
extern const Be::VarChooser TriSwapEffect[];
extern const Be::VarChooser TriPresentFlag[];
extern const Be::VarChooser TriMultiSampleType[];
extern const Be::VarChooser TriPresent[];
...
extern const Be::VarChooser TriPool[];
extern const Be::VarChooser TriFVF[];
extern const Be::VarChooser TriUsage[];
extern const Be::VarChooser TriUsageVertexIndex[];
extern const Be::VarChooser TriVertexDeclType[];
extern const Be::VarChooser TriVertexDeclMethod[];
extern const Be::VarChooser TriSetGammaRamp[];
extern const Be::VarChooser TriHACKFORTESTING[];
extern const Be::VarChooser TriPresentMethodFlag[];
